										...
										<?foreach($arTabOrder as $value):?>
											...
											<?if($value == "desc"):?>
												<?if($bShowDetailTextTab || ($arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB" && $bShowPropsTab)):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>"><a href="#desc" data-toggle="tab"><?=($arParams["T_DESC"] ? $arParams["T_DESC"] : Loc::getMessage("T_DESC"));?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show char block?>
											<?if($value == "char"):?>
												<?if($bShowPropsTab && $arParams["PROPERTIES_DISPLAY_LOCATION"] == "TAB"):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>"><a href="#props" data-toggle="tab"><?=($arParams["T_CHARACTERISTICS"] ? $arParams["T_CHARACTERISTICS"] : Loc::getMessage("T_CHARACTERISTICS"));?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show howbuy block?>
											<?if($value == "buy"):?>
												<?if($bShowHowBuyTab):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>"><a href="#buy" data-toggle="tab"><?=$arParams["TITLE_HOW_BUY"];?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show payment block?>
											<?if($value == "payment"):?>
												<?if($bShowPaymentTab):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>"><a href="#payment" data-toggle="tab"><?=$arParams["TITLE_PAYMENT"];?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show delivery block?>
											<?if($value == "delivery"):?>
												<?if($bShowDeliveryTab):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>"><a href="#delivery" data-toggle="tab"><?=$arParams["TITLE_DELIVERY"];?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show stores block?>
											<?if($value == "stores"):?>
												<?if($bShowStoresTab):?>
													<li class="bordered  <?=(!($iTab++) ? 'active' : '')?>"><a href="#stores" data-toggle="tab"><?=$arParams["TAB_STOCK_NAME"];?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show custom_tab block?>
											<?if($value == "custom_tab"):?>
												<?if($bShowCustomTab):?>
													<li class="bordered  <?=(!($iTab++) ? 'active' : '')?>"><a href="#custom_tab" data-toggle="tab"><?=$arParams["TAB_DOPS_NAME"];?></a></li>
												<?endif;?>
											<?endif;?>
											<?//show reviews block?>
											<?if($value == "reviews"):?>
												<?if($bShowReviewsTab):?>
													<li class="bordered <?=(!($iTab++) ? 'active' : '')?>">
