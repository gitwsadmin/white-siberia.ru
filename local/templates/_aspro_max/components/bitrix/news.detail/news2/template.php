...
?>
<div class="detail_wrapper detail-news_one">
		<div class="text_news_one">
...
<?php
	//if($USER->IsAdmin()) print_r($arResult);
?>
...
<?echo '<span id="mob_img" style="display:none;">'.$arResult["DETAIL_PICTURE"]["SRC"].'</span>';?>
