...
<div class="main-catalog-wrapper clearfix">
	<div class="section-content-wrapper <?=($bShowLeftBlock ? 'with-leftblock' : '');?>">
		...
		if($catalogInfoIblockId && !$bSimpleSectionTemplate || true){
...
<script> if($('.group_description_block.bottom.muted777.smartseo-block').length>0) $('.group_description_block.bottom.muted777').not('.smartseo-block').remove(); </script>