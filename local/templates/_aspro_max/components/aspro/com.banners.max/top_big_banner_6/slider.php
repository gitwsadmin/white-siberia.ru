<?global $arTheme, $USER;
$bHideOnNarrow = $arTheme['BIGBANNER_HIDEONNARROW']['VALUE'] === 'Y';?><div class="top_slider_wrapp maxwidth-banner<?=($bHideOnNarrow ? ' hidden_narrow' : '')?>">
									...
									<?ob_start();?>
										<td class="text <?=$arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"];?>">
											...
											<?else:?>
												...
												?>
												<?if($arItem["NAME"] && $arItem['PROPERTIES']['SHOWNAMEBNR']['VALUE']=="Да"):?>
													<div class="banner_title">
														<?echo $arItem['PROPERTIES']['SHOWNAMEBNR']['VALUE'];?>
