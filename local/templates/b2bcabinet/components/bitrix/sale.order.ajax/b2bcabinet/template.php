...
if (empty($arResult['PERSON_PROFILE']) && $arResult["EXTENDED_VERSION_COMPANIES"] != "Y") {
    ?>
    <div style="margin-left: 20px;">
        <p>
            ...
            echo Loc::getMessage(
                ...
                array(
                    "#ADD_ORG_LINK#" => SITE_DIR . (Option::get('sotbit.b2bcabinet', 'method_install',
                            '', SITE_ID) == 'AS_TEMPLATE' ?
                            'b2bcabinet/' :
...
if (!$_SESSION["AUTH_COMPANY_CURRENT_ID"] && $arResult["EXTENDED_VERSION_COMPANIES"] == "Y") {
    ?>
    <div style="margin-left: 20px;">
        <p>
            <?
...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" class="container" enctype="multipart/form-data">
		<?
    ...
    <!--					<div data-type="informer" style="display:none"></div>-->
                    ...
                    <div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
                        <div class="bx-soa-section-title-container row">
					...
					<div class="bx-soa-section bx-active d-lg-none">
						<div class="bx-soa-section-title-container row">
							<h2 class="bx-soa-section-title col-sm-12">
								<span class="bx-soa-section-title-icon">
									<i class="icon-list-unordered"></i>
								</span><?=Loc::getMessage('CART_TITLE')?>
							</h2>
						</div>
						<div id="bx-soa-total-mobile" class="bx-soa-section-content" style="margin-bottom: 6px;"></div>
					</div>
                        ...
                        <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                            <div class="bx-soa-section-title-container row">
                                <h2 class="bx-soa-section-title col-sm-12">
									...
									</span><?=$arParams['MESS_BASKET_BLOCK_NAME']?>
                                </h2>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                    ...
                    <div id="bx-soa-profile" class="bx-soa-section">
                        <?if ($arParams['ALLOW_USER_PROFILES'] == "Y") {?>
                            <div class="bx-soa-section-title-container row">
                                <h2 class="bx-soa-section-title col-sm-12">
                                    <span class="bx-soa-section-title-icon">
                                        <i class="icon-collaboration"></i>
                                    </span><?=getMessage("SELECT_PROFILE_DEFAULT")?>
                                </h2>
                            </div>
                        <?}?>
                    </div>
                    ...
                    <div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
                        <div class="bx-soa-section-title-container row">
                            <h2 class="bx-soa-section-title col-sm-12">
								...
								</span><?=$arParams['MESS_REGION_BLOCK_NAME']?>
                            </h2>
                        </div>
                        <div class="bx-soa-section-content container-fluid"></div>
                    </div>
                        ...
                        <div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
                            <div class="bx-soa-section-title-container row">
                                <h2 class="bx-soa-section-title col-sm-12">
									...
									</span><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?>
                                </h2>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                        ...
                        <div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
                            <div class="bx-soa-section-title-container row">
                                <h2 class="bx-soa-section-title col-sm-12">
									...
									</span><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?>
                                </h2>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                    ...
                    <? else: ?>
                        ...
                        <div id="bx-soa-pickup" data-visited="false" class="bx-soa-section" style="display:none">
                            <div class="bx-soa-section-title-container row">
                                <h2 class="bx-soa-section-title col-sm-12">
                                    <span class="bx-soa-section-title-icon"></span>
                                </h2>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                    ...
                    <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
                        <div class="bx-soa-section-title-container row">
                            <h2 class="bx-soa-section-title col-sm-12">
                                <span class="bx-soa-section-title-icon">
									<i class="icon-user"></i>
								</span><?=$arParams['MESS_BUYER_BLOCK_NAME']?>
                            </h2>
                        </div>
                        <div class="bx-soa-section-content container-fluid"></div>
                    </div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar d-none d-lg-flex">
				<div class="bx-soa-cart-total-ghost"></div>
                <div class="bx-soa-cart-total-title"><?=Loc::getMessage('CART_TITLE')?></div>
				<div class="bx-soa-cart-total card"></div>
			</div>
		</div>
	</form>
	...
	<script>
        function SetContact(profileId) {
            ...
            $('[name="PERSON_TYPE_OLD"]').val($('#PROFILE_ID_' + profileId).data('person-type'));
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			userProfileBlockId: 'bx-soa-profile',
        ...
        }).on('change', BX.Sale.OrderAjaxComponent.sendRequest.bind(BX.Sale.OrderAjaxComponent));
	</script>
	<script>
		<?
