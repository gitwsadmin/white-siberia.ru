...
?>
<style>.right_block.wide_, body .right_block.wide_N{float:none !important;width:100% !important;}.top-block-wrapper{display: none;}</style>
	...
	<div class="page_error_block">
		<div class="page_not_found" width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<div class="description">
				<div class="subtitle404" style="color: #ccc">Страница не найдена</div>
