...
$APPLICATION->SetPageProperty("keywords", "Интернет-магазин электротранспорта, купить электросамокат, электромотоцикл, квадроцикл, электровелосипед");
$APPLICATION->SetPageProperty("title", "Каталог товаров от компании White Siberia");
$APPLICATION->SetPageProperty("description", "Каталог товаров от компании White Siberia: техника, ✅ аксессуары и тюнинг для электробайков, ✅ запчасти для электробайков, ✅ аксессуары, тюнинг и запчасти для Электросамокатов");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_EXPANDABLES_TITLE" => "Аксессуары на эту модель",
		"DETAIL_ASSOCIATED_TITLE" => "Запчасти на эту модель",
		...
		"BLOCK_ADDITIONAL_GALLERY_NAME" => "Живые фото",
		"STORES_FILTER" => "TITLE",
		...
		"DETAIL_BLOCKS_TAB_ORDER" => "desc,stores,char,video,reviews,buy,payment,delivery,custom_tab,buy_services",
