...
$APPLICATION->SetPageProperty("description", "Сотрудники компании WHITE SIBERIA в России: руководители, отдел по работе с партнерами, отдел продаж, отдел маркетинга, юридический отдел, Отдел ИТ.");
$APPLICATION->SetPageProperty("title", "Сотрудники | White Siberia");
