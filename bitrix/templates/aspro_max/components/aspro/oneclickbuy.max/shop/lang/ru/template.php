...
$MESS['FORM_HEADER_CAPTION'] = 'Купить в кредит от Тинькофф';
...
$MESS['DELIVERY_NOTE_TITLE'] = 'Стоимость доставки'; // текст о стоимости доставки меняется в файле /include/oneclick_delivery_text.php
$MESS['CAPTCHA_LABEL'] = 'Введите текст с картинки';
$MESS['ADD_BTN'] = 'Добавить';
$MESS['REMOVE_FILE'] = 'Отменить выбор файла';
$MESS['ONE_CLICK_SMS_CODE_LABEL'] = 'Код подтверждения из СМС';
$MESS['ONE_CLICK_REQUEST_ERROR'] = 'Ошибка запроса';
$MESS['ONE_CLICK_SUCCESS'] = 'В ближайшее время наш менеджер свяжется с вами.';
$MESS["ONE_CLICK_SMS_SEND"] = "Отправить";
$MESS["ONE_CLICK_BACK"] = "Вернуться в каталог";
?>
