...
<div class="product-info <?=(!$showCustomOffer ? "noffer" : "");?> bordered rounded3" id="<?=$arItemIDs["strMainID"];?>">
	...
	<div class="product-detail-gallery swipeignore left_info js-notice-block__image">
		<div class="product-detail-gallery__container<?=($bVertical ? ' product-detail-gallery__container--vertical' : '');?>">
			...
			<div class="product-detail-gallery__slider <?= $bMagnifier ? 'hidden-xs' : 'product-detail-gallery__slider--big owl-carousel owl-theme owl-bg-nav short-nav'; ?> <?=$arParams['PICTURE_RATIO'];?>" data-plugin-options='{"items": "1", "dots": true, "nav": true, "relatedTo": ".product-detail-gallery__slider.thmb", "loop": false}'>
