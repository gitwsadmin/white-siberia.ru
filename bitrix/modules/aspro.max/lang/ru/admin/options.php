...
$MESS["MAX_MODULE_NOT_INSTALLED"] = 'Модуль &laquo;Аспро: Максимум - интернет-магазин&raquo; не установлен. Пожалуйста, <a href="/bitrix/admin/partner_modules.php">установите модуль</a> и повторите попытку.';
...
$MESS["MIN_ORDER_PRICE_TEXT_EXAMPLE"] = "<b>Минимальная сумма заказа #PRICE#</b><br/>
...
$MESS["PURCHASE_ORDER_EVENT_TITLE"] = "Метка события \"Успешное оформления заказа\" в google tag manager";
...
$MESS["ASPRO_SOLUTION_REQUIRED_FIELDS"] = "Обязательные настройки для быстрого запуска";
$MESS["BASE_COLOR_GROUP"] = "Цвет сайта";
$MESS["LOGO_GROUP"] = "Логотип";
$MESS["SECTION_CONTACTS_GROUP"] = "Контакты";
$MESS["COUNTERS_GOALS_GROUP"] = "Счетчики";
$MESS["COUNTERS_GOALS_GROUP2"] = "Цели Яндекс.Метрики";
$MESS["COUNTERS_GOALS_GROUP3"] = "Электронная коммерция Яндекс";
$MESS["COUNTERS_GOALS_GROUP4"] = "Электронная коммерция Google";

$MESS["PAGE_WIDTH_GROUP"] = "Ширина сайта";
$MESS["FONT_GROUP"] = "Шрифт";
$MESS["BGCOLOR_THEME_GROUP"] = "Фоновый баннер";
$MESS["MENU_GROUP"] = "Меню в шапке";
$MESS["LEFT_BLOCK_GROUP"] = "Внутреннее меню";
$MESS["SEARCH_GROUP"] = "Тип поиска";
$MESS["CALLBACK_GROUP"] = "Заказать звонок";
$MESS["PAGE_TITLE_GROUP"] = "Заголовки и навигационные цепочки";
$MESS["SHOW_LICENCE_GROUP"] = "Обработка персональных данных";
$MESS["UP_BTN_GROUP"] = "Кнопка «Наверх»";
$MESS["CONFIG_GROUP"] = "Настройки";
$MESS["VALIDATE_GROUP"] = " ";
$MESS["FRONT_TEMPLATE_GROUP"] = "Вид отображения блоков на главной";
$MESS["FRONT_BANNER_GROUP"] = "Большой баннер";
$MESS["FRONT_PARTNERS_GROUP"] = "Блок «Наши партнеры»";
$MESS["HEADER_FIXED_GROUP"] = "Фиксированная шапка";
$MESS["HEADER_TYPE_GROUP"] = "Варианты шапок";
$MESS["REGIONALITY_VIEW_GROUP"] = "Внешний вид";
$MESS["REGIONALITY_CONDITION_GROUP"] = "Зависимость контента от региональности";
$MESS["FILTER_VIEW_GROUP"] = "Умный фильтр";
$MESS["MAIN_ALL_GROUP"] = "Общие настройки";
$MESS["SEARCH_VIEW_TYPE_GROUP"] = "Поиск";
$MESS["MENU_TYPE_VIEW_GROUP"] = "Меню каталога на внутренних страницах";
$MESS["SHOW_SECTION_DESCRIPTION_GROUP"] = "Описание в разделах каталога";
$MESS["CATALOG_PAGE_DETAIL_GROUP"] = "Детальная страница";
$MESS["CATALOG_PAGE_GROUP"] = "Страница списка";
$MESS["TYPE_SKU_GROUP"] = "Торговые предложения (SKU)";
$MESS["TOTAL_SUMM_GROUP"] = "Цена";
$MESS["SHOW_BREADCRUMBS_CATALOG_GROUP"] = "Навигационная цепочка";
$MESS["RECENT_VIEWED_GROUP"] = "Просмотренные товары";
$MESS["QUANTITY_FOR_GROUPS_GROUP"] = "Для кого отображать";
$MESS["QUANTITY_EXPRESSION_GROUP"] = "Вид значения";
$MESS["EXPRESSION_ADDTOBASKET_GROUP"] = "Кнопки «В корзину» и «Подробнее»";
$MESS["EXPRESSION_SUBSCRIBE_GROUP"] = "Кнопки «Подписаться» и «Под заказ»";
$MESS["EXPRESSION_PRINT_GROUP"] = "Кнопки «Версия для печати» и «Быстрый просмотр»";
$MESS["EXPRESSION_QUANTITY_GROUP"] = "Наличие";
$MESS["EXPRESSION_BASKET_GROUP"] = "Кнопки в корзине";
$MESS["EXPRESSION_CALCULATE_DELIVERY_GROUP"] = "Расчет доставки";
$MESS["ORDER_BASKET_GROUP"] = "Внешний вид";
$MESS["ORDER_BASKET_CONFIG_GROUP"] = "Настройки";
$MESS["BUYNOPRICEGGOODS_GROUP"] = "Кнопки у товара с нулевой/отсутствующей ценой или у отсутствующего товара";
$MESS["MIN_ORDER_PRICE_GROUP"] = "Минимальная цена";
$MESS["ONE_CLICK_BUY_DATA_GROUP"] = "Данные о плательщике и заказе";
$MESS["ONE_CLICK_BUY_CONFIG_GROUP"] = "Форма заявки";
$MESS["BLOG_PAGE_GROUP"] = "Блог";
$MESS["SERVICE_PAGE_GROUP"] = "Услуги";
$MESS["PROJECTS_PAGE_GROUP"] = "Проекты";
$MESS["NEWS_PAGE_GROUP"] = "Новости";
$MESS["LOOKBOOKS_PAGE_GROUP"] = "Образы";
$MESS["STAFF_PAGE_GROUP"] = "Компания";
$MESS["HEADER_MOBILE_FIXED_GROUP"] = "Мобильная шапка";
$MESS["HEADER_MOBILE_MENU_GROUP"] = "Мобильное меню";

$MESS["SALE_PAGE_GROUP"] = "Акции";
$MESS["LANDINGS_PAGE_GROUP"] = "Коллекции";
$MESS["PROJECTS_SHOW_HEAD_BLOCK_GROUP"] = 'Отображение верхнего блока раздела "Проекты"';

$MESS["CUSTOM_COLOR_CHOOSE"] = "Выбрать";
$MESS["CUSTOM_COLOR_CANCEL"] = "Отменить";
$MESS["NOTHING_FOUND"] = "Ничего не найдено";
$MESS["FILTER_SEARCH"] = "Фильтр + поиск";
$MESS["SEARCH_CLICK"] = "Найти";
$MESS["REMOVE_CLICK"] = "Очистить";
...
$MESS["MAX_MODULE_CURL_INFO"] = "Для работы функционала нужна библиотека cURL";

$MESS['TABS_SETTINGS'] = 'Настройки отображения табов';

$MESS["SHOW_OFFER_GROUP"] = "Публичная оферта";
$MESS["FOOTER_DEVELOPER_GROUP"] = "Информация о разработчике";
?>