...
class CAsproMarketingMax{
    const MODULE_ID = \CMax::moduleID;
    const LOCAL_DIR_TMPL = "/modules/aspro.max/preset/template/";
    // const LOCAL_DIR_IMG = '/images/'.CMax::moduleID.'/preset/template/';
    ...
    public static function senderTemplateList(){
        ...
        $arResultList[] = array(
            'TYPE' => 'ADDITIONAL',
            'ID' => 'aspro_friday_start',
            'NAME' => Loc::getMessage('ASPRO_TEMPLATE_START'),
            'ICON' => '/bitrix/images/aspro.max/preset/friday_start.jpg',
            'HTML' => static::getById('aspro_friday_start'),
            'DESC' => Loc::getMessage('ASPRO_TEMPLATE_FRIDAY_START_DESC'),
        );
        $arResultList[] = array(
            'TYPE' => 'ADDITIONAL',
            'ID' => 'aspro_friday_announce',
            'NAME' => Loc::getMessage('ASPRO_TEMPLATE_FRIDAY_ANNOUNCE'),
            'ICON' => '/bitrix/images/aspro.max/preset/friday_announce.jpg',
            'HTML' => static::getById('aspro_friday_announce'),
            'DESC' => Loc::getMessage('ASPRO_TEMPLATE_FRIDAY_ANNOUNCE_DESC'),
        );
        $arResultList[] = array(
            'TYPE' => 'ADDITIONAL',
            'ID' => 'aspro_friday_last',
            'NAME' => Loc::getMessage('ASPRO_TEMPLATE_FRIDAY_LAST'),
            'ICON' => '/bitrix/images/aspro.max/preset/friday_last.jpg',
            'HTML' => static::getById('aspro_friday_last'),
            'DESC' => Loc::getMessage('ASPRO_TEMPLATE_FRIDAY_LAST_DESC'),
        );
        return $arResultList;
    }
    ...
    public static function replaceTemplateByDefaultData($template){
        ...
        $tizer_iblock_id = ($arIblocks["aspro_max_content"]["aspro_max_tizers"][0] ? $arIblocks["aspro_max_content"]["aspro_max_tizers"][0] : 0);
        $sale_iblock_id = ($arIblocks["aspro_max_content"]["aspro_max_stock"][0] ? $arIblocks["aspro_max_content"]["aspro_max_stock"][0] : 0);
        ...
        $arModuleOptions = \CMax::GetBackParametrsValues($site_id);
        $arThemeValues = array();
        ...
        return str_replace(
            ...
            '%FRIDAY_ANNOUNCE_TEXT_TOP%', '%FRIDAY_ANNOUNCE_TEXT_BOTTOM%', '%FRIDAY_ANOUNCE_BUTTON%','%FRIDAY_START_TEXT%','%FRIDAY_GOODS_TITLE%','%FRIDAY_START_BUTTON%',
            '%FRIDAY_LAST_BUTTON%','%FRIDAY_LAST_TEXT_TOP%','%FRIDAY_LAST_TEXT_BOTTOM%',
            ),
            array(
            ...
            Loc::getMessage('FRIDAY_ANNOUNCE_TEXT_TOP'),Loc::getMessage('FRIDAY_ANNOUNCE_TEXT_BOTTOM'),Loc::getMessage('FRIDAY_ANOUNCE_BUTTON'),Loc::getMessage('FRIDAY_START_TEXT'),Loc::getMessage('FRIDAY_GOODS_TITLE'),Loc::getMessage('FRIDAY_START_BUTTON'),
            Loc::getMessage('FRIDAY_LAST_BUTTON'),Loc::getMessage('FRIDAY_LAST_TEXT_TOP'),Loc::getMessage('FRIDAY_LAST_TEXT_BOTTOM'),
            ),
            $themeContent
        );
    }
