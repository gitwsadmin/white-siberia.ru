				...
				<?ob_start();?>
					...
					<?else:?>
						<?if($arItems["PICTURE"]["SRC"]):?>
							...
							<a href="<?=$arItems["SECTION_PAGE_URL"]?>" class="thumb shine"><img class="lazy img-responsive" data-src="<?=$img["src"]?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($img["src"]);?>" alt="<?=($arItems["PICTURE"]["ALT"] ? $arItems["PICTURE"]["ALT"] : $arItems["NAME"])?>" title="<?=($arItems["PICTURE"]["TITLE"] ? $arItems["PICTURE"]["TITLE"] : $arItems["NAME"])?>" /></a>
