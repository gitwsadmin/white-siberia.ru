...
$APPLICATION->SetPageProperty("title", "Вопросы и ответы | White-Siberia производитель электротранспорта. Доставка по РФ");
$APPLICATION->SetPageProperty("description", "Вопросы и ответы о магазине White Siberia");
